...
class BrainDataset(Dataset):
    def __init__(self, annotations_file, transform=None, target_transform=None, device=torch.device('cuda:1')):
...
def add_gauss(example, prob:float=0.0, device=torch.device('cuda:1')):
